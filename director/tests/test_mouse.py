...
class TestPosition:
    @patch("thea_director.mouse.xdotool.mouse_location", return_value=(100, 200))
...
class TestMoveTo:
    @patch("thea_director.mouse.time.sleep")
    @patch("thea_director.mouse.time.monotonic")
    @patch("thea_director.mouse.xdotool.mouse_move")
    @patch("thea_director.mouse.xdotool.mouse_location", return_value=(0, 0))
    ...
    @patch("thea_director.mouse.time.monotonic")
    @patch("thea_director.mouse.xdotool.mouse_move")
    @patch("thea_director.mouse.xdotool.mouse_location", return_value=(500, 500))
...
class TestClick:
    @patch("thea_director.mouse.xdotool.mouse_click")
    @patch("thea_director.mouse.Mouse.move_to")
    @patch("thea_director.mouse.time.sleep")
...
class TestDrag:
    @patch("thea_director.mouse.xdotool.mouse_up")
    @patch("thea_director.mouse.xdotool.mouse_down")
    @patch("thea_director.mouse.Mouse.move_to")
    @patch("thea_director.mouse.time.sleep")
