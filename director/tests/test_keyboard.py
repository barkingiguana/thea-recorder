...
class TestType:
    @patch("thea_director.keyboard.time.sleep")
    @patch("thea_director.keyboard.xdotool.key_type_char")
...
class TestPress:
    @patch("thea_director.keyboard.time.sleep")
    @patch("thea_director.keyboard.xdotool.key_press")
...
class TestHoldRelease:
    @patch("thea_director.keyboard.xdotool.key_down")
    def test_hold(self, mock_down):
        kb = Keyboard(ENV)
        kb.hold("Shift_L")
        mock_down.assert_called_once_with("Shift_L", ENV)

    @patch("thea_director.keyboard.xdotool.key_up")
